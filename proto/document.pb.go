...
type TDocument struct {
	...
	PubDate        uint64 `protobuf:"varint,2,opt,name=pub_date,json=pubDate,proto3" json:"pub_date,omitempty"`
	FetchTime      uint64 `protobuf:"varint,3,opt,name=fetch_time,json=fetchTime,proto3" json:"fetch_time,omitempty"`
	Text           string `protobuf:"bytes,4,opt,name=text,proto3" json:"text,omitempty"`
	FirstFetchTime uint64 `protobuf:"varint,5,opt,name=first_fetch_time,json=firstFetchTime,proto3" json:"first_fetch_time,omitempty"`
}
...
var file_proto_document_proto_rawDesc = []byte{
	...
	,
...
var file_proto_document_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_document_proto_goTypes = []any{
	(*TDocument)(nil), // 0: proto.TDocument
}
...
func file_proto_document_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_document_proto_msgTypes[0].Exporter = func(v any, i int) any {
